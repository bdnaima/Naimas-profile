        ...
        <div className="card about-section">
          <div className="card-body">
            ...
            <p className="card-text" style={{ textAlign: "center" }}>
              Below are four web applications I created using HTML, CSS, React
              and Bootstrap.{" "}
            </p>
          </div>
        </div>
      ...
      <div className="container projects-alignment">
        ...
        <div className="card projects">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This was a small project that is a gallery website where you sign
              in and can create your own albums and add photos. You can also
              copy, share and edit albums.
            </p>
            <a
        ...
        <div className="card projects">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This was a recent small project where I created an example landing
              page for code testing. I created the page using only HTML and CSS.
            </p>
            <a
